...
void printInteraction(void)
{
	...
	std::cout << "Press the left/right or up/down keys to move the sweeping curve." << std::endl
		<< "Press the space key to toggle between sweeping the surface in either direction." << std::endl;
}
