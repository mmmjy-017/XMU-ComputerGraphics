...
// squareGLFW.cpp
//
// This program is square.cpp rewritten to use GLFW to manage the window
// instead of FreeGLUT. All GLFW calls are commentated.
//
// Configuring the environment to run this project: Download at the link
// https://github.com/glfw/glfw/releases/download/3.2.1/glfw-3.2.1.bin.WIN32.zip
// and unzip glfw-3.2.1.bin.WIN32 and save it in C:\OpenGLwrappers 
// (see our Windows install guide for how we set up this folder of helper libraries).
//
// NOTE: If the program doesn't run in MSVS 2015, try MSVS 2017 (build tool issues).
//
// Sumanta Guha
/////////////////////////////////////////////////////////////////////////////////////
