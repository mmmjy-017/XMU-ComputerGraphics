...
void printInteraction(void)
{
	...
	std::cout << "Press space to select a control point." << std::endl
		<< "Press the arrow keys to move the selected control point." << std::endl
		<< "Press the page up/down keys to increase/decrease the weight of the selected control point." << std::endl
		<< "Press delete to reset the control points." << std::endl;
}
