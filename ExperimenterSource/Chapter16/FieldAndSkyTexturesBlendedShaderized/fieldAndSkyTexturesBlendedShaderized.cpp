...
void setup(void) 
{
   ...
   // ...and associate field data with vertex shader.
   ...
   // ...and associate sky data with vertex shader.
   ...
   // ...and associate line data with vertex shader.
   glBindVertexArray(vao[LINE]);
   glBindBuffer(GL_ARRAY_BUFFER, buffer[LINE_VERTICES]);
   glBufferData(GL_ARRAY_BUFFER, sizeof(lineVertices), lineVertices, GL_DYNAMIC_DRAW);
   glVertexAttribPointer(5, 4, GL_FLOAT, GL_FALSE, sizeof(Vertex), 0);
...
void printInteraction(void)
{
   ...
   std::cout << "Press the arrow keys to change the direction of the sun." << std::endl;
}
