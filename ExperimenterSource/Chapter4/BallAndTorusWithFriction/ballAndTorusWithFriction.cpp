...
void printInteraction(void)
{
	...
	std::cout << "Keep space key pressed to apply force to the ball. Release to stop application." << std::endl
		<< "Press up/down arrow keys to increase/decrease the applied force." << std::endl
		<< "Press page up/down keys to increase/decrease the viscous drag." << std::endl
