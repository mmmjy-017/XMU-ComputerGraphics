...
// turnFilmBezier.cpp
//
// This program draws a fixed magenta polynomial Bezier curve with fixed control points
// on the z=1 plane. Intially the film lies along the z=1 plane as well but it can be
// turned towards the x=1 plane. Also drawn in blue is the polynomial Bezier curve
// approximating the projection of the control points on the film, as well as, optionally,
// a green rational Bezier curve that coincides with the projection of the red curve.
//
// Interaction:
...
void drawScene()
{
	...
	// The magents curve and the black control points are fixed in world co-ordinates and viewed on the film turned
	...
	// Draw the magenta polynomial Bezier curve approximating the fixed control points on z=1.
	...
	if (showPolyCurve)
    // Draw the blue polynomial Bezier curve approximating the projections of the control points on the
    // turned film.
	{
	...
	// Draw the green rational Bezier curve approximating the projected control points on the
...
void printInteraction(void)
{
	...
	std::cout << "Initially the film is along the z = 1 plane." << std::endl
		<< "Press the right arrow key to turn the film towards the x = 1 plane." << std::endl
		<< "Press the left arrow key to turn the film back towards the z = 1 plane." << std::endl
		<< "Press space to see the rational Bezier curve." << std::endl;
}
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("turnFilmBezier.cpp");
