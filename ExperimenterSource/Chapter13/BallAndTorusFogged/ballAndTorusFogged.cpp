////////////////////////////////////////////////////////////////
// ballAndTorusFogged.cpp
//
// This program adds fog to ballAndTorusShadowed.cpp.
//
// Interaction:
// Press delete to toggle between fog on and off.
...
static float fogStart = 0.0; // Fog start z value, NOT USED CURRENTLY.
static float fogEnd = 1.0; // Fog end z value, NOT USED CURRENTLY.
...
void setup(void)
{
	...
	glFogf(GL_FOG_START, fogStart); // NOT USED CURRENTLY.
	glFogf(GL_FOG_END, fogEnd); // NOT USED CURRENTLY.
...
void drawScene(void)
{
	...
	if (isFog) glEnable(GL_FOG); else glDisable(GL_FOG); // Turn fog on/off,
...
void printInteraction(void)
{
	...
	std::cout << "Press delete to toggle between fog on and off." << std::endl
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("ballAndTorusFogged.cpp");
